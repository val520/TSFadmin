    ...
    <el-card class="box-card">
      ...
      >
        <el-row v-show="currentTab === 0" :gutter="24">
          ...
          <el-col :span="24">
            ...
            <el-form-item label="是否需要审核">
              <el-radio-group v-model="formValidate.isCheck">
                <el-radio :label="1" class="radio">否</el-radio>
                <el-radio :label="0">是</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="价格设置：" props="isSub">
                ...
                >
                  <template slot-scope="scope">
                    <el-input
                      ...
                      :type="
                        formThead[iii].title === '商品编号' ? 'text' : 'number'
                      "
                      :min="0"
                      class="priceBox"
                      @keyup.native="
                        keyupEvent($event, oneFormBatch, scope.$index, iii, 1)
                      "
                    />
                  </template>
                </el-table-column>
                ...
                >
                  <template slot-scope="scope">
                    <el-input
                      ...
                      class="priceBox"
                      @keyup.native="
                        keyupEvent($event, oneFormBatch, scope.$index, iii, 2)
                      "
                    />
                  </template>
                </el-table-column>
                ...
                >
                  <template slot-scope="scope">
                    ...
                    <el-input
                      ...
                      class="priceBox"
                      @keyup.native="
                        keyupEvent($event, oneFormBatch, scope.$index, iii, 3)
                      "
                    />
                  </template>
                </el-table-column>
        ...
        <el-form-item>
          ...
          > -->
          <el-button
            v-show="(currentTab === 0 || $route.params.id) && !isDisabled"
            type="primary"
            class="submission"
